...
<form id="frmContactPersoon" method="POST" action="http://localhost:8080/sociaalhuis/wp-content/plugins/tieltvrijwilligt/appcode/control/contactpersoon.control.php" class="form-horizontal" enctype="multipart/form-data" onsubmit="return validateFrm()">
            ...
            <div class="control-group">
                 ...
                 <div class="controls"><input id="voornaamContactPersoon" name="voornaamContactPersoon" type="text"  value="<?php if(isset($cPersoon)) {echo $cPersoon[0]['contVoornaam'];} ?>" required><span class="asterisk_input"></span></div>
            </div>
