...
?>
<a href="http://localhost:8080/sociaalhuis/tieltse-verenigingen" class="buttonback" title="Terug naar Tieltse verenigingen">&nbsp;Terug</a>
...
<h3 style="display: inline-block;">Contactpersoon</h3><span> voor nieuwe leden</span>
<div><?php echo "Naam: ".$contactPersoon[0]['contVoornaam']." ".$contactPersoon[0]['contNaam'];?></div>
<?php if(!empty($contactPersoon[0]['contEmail']))
{
?>
<div><?php echo "E-mail adres: ".$contactPersoon[0]['contEmail'];?></div>
<?php
}
?>
