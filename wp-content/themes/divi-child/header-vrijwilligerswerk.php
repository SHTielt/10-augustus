...
<head>
	...
	<?php wp_head(); ?>
	<script src="https://cdn.vrijwilligerswerk.be/0617ef79-f75f-427b-8994-f3ee2c1a6407/search/v1/widget.js?t=20170626084108" defer></script>
</head>
<body <?php body_class(); ?>>
...
?>
	...
	<?php if ( $et_top_info_defined && ! $et_slide_header || is_customize_preview() ) : ?>
		<div id="top-header"<?php echo $et_top_info_defined ? '' : 'style="display: none;"'; ?>>
			...
			<?php wp_nav_menu( array( 'theme_location' => 'account-menu', 'container_class' => 'account_class' ) ); ?>
			<?php 
   			$ingelogde_user = wp_get_current_user();
   
   			if ($ingelogde_user->ID != 0)
   			{
