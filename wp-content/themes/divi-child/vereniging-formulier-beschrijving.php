...
{
?>
 <a href="<?php echo "http://localhost:8080/sociaalhuis/vereniging-formulier-bestuur?verenigingid=".$_POST['verenigingId'];?>" class="pull-right buttonnext" title="<?php echo "Naar bestuur van ".$result[0]['verNaam']; ?>">&nbsp;Naar bestuur</a> 
<?php	
}
?>
...
<form id="frmVereniging" method="POST" action="http://localhost:8080/sociaalhuis/wp-content/plugins/tieltvrijwilligt/appcode/control/verenigingbeschrijving.control.php" class="form-horizontal" enctype="multipart/form-data" onsubmit="return validateFrm()">
            <div class="control-group">
                 <label for="naamVereniging" class="control-label">NAAM:</label>
                 <div class="controls"><input id="naamVereniging" name="naamVereniging" type="text" value="<?php if(isset($result)) {echo $result[0]['verNaam'];} ?>" required><span class="asterisk_input"></span></div>
            </div>
