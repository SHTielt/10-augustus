   jQuery(document).ready(function () {
    		...
    		var tabel = jQuery("#functiesTabel");
            ...
            jQuery("table").on("click", "button.btndelete", deleteFunctie);
            
            //6.export to excel
            jQuery("#btnexcel").click(function(){
            alert('hi');
            jQuery("#functiesTabel").table2excel({
        	// exclude CSS class
        	exclude: ".noExl",
        	name: "Functies",
        	filename: "functies", 
            ...
            */
            ...
            function deleteFunctie() {
                ...
                */
                ...
                var r = confirm("Bent u zeker om deze functie te verwijderen?");
                if(r == true)
                {
                    window.location.href = 'http://localhost:8080/sociaalhuis/wp-content/plugins/tieltvrijwilligt/appcode/control/functie.control.php?functieid=' + id;
