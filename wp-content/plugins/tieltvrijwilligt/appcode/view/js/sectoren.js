   jQuery(document).ready(function () {
    		...
    		var tabel = jQuery("#sectorenTabel");
            ...
            jQuery("table").on("click", "button.btndelete", deleteSector);
            
            //6.export to excel
            jQuery("#btnexcel").click(function(){
            alert('hi');
            jQuery("#sectorenTabel").table2excel({
        	// exclude CSS class
        	exclude: ".noExl",
        	name: "Sectoren",
        	filename: "sectoren", 
            ...
            */
            ...
            function deleteSector() {
                ...
                */
                ...
                var r = confirm("Bent u zeker om deze sector te verwijderen?");
                if(r == true)
                {
                    window.location.href = 'http://localhost:8080/sociaalhuis/wp-content/plugins/tieltvrijwilligt/appcode/control/sector.control.php?sectorid=' + id;
